...
async function syncIndiciadosPhysicalDetails() {
  try {
    console.log('🔄 Conectando a la base de datos...');
    await sequelize.authenticate();
    console.log('✅ Conexión establecida correctamente.');

    console.log('🔄 Agregando campos físicos detallados a la tabla indiciados_simple...');
    
    // Sincronizar modelo con nuevos campos
    await IndiciadoSimple.sync({ alter: true });
    
    console.log('✅ Campos físicos detallados agregados exitosamente a indiciados_simple');
...
module.exports = { syncIndiciadosPhysicalDetails };
